...
def load_h5_cache_file(
    cachefile,
    use_cached,
    valid_if_metadata_is=None,
    relevant_if_metadata_above=None,
    relevant_if_metadata_below=None,
    current_version="",
    ...
    """
    valid_if_metadata_is = {} if valid_if_metadata_is is None else valid_if_metadata_is
    relevant_if_metadata_above = {} if relevant_if_metadata_above is None else relevant_if_metadata_above
    relevant_if_metadata_below = {} if relevant_if_metadata_below is None else relevant_if_metadata_below
...
def check_cache_file(
    fcache, use_cached=True, expected_metadata=None, verbose=True, engine="auto"
):
...
def check_not_deprecated(
    ...
    """
    metadata_is = {} if metadata_is is None else metadata_is
    metadata_keys_contain = [] if metadata_keys_contain is None else metadata_keys_contain
    if engine == "auto":
...
def filter_metadata(arguments, discard_variables=None):
    ...
    How to get only function argument::
        ...
        def some_function(*args):
            ...
            ...
    """
    discard_variables = ["self", "verbose"] if discard_variables is None else discard_variables
